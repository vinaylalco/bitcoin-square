        ...
        <div className="grid gap-8 px-6 py-10 sm:px-10 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-brand via-brand/90 to-black px-6 py-3 text-sm font-semibold uppercase tracking-[0.32em] text-white shadow-[0_25px_55px_rgba(239,68,68,0.4)] transition hover:-translate-y-1 hover:shadow-[0_35px_70px_rgba(239,68,68,0.45)]"
            >
