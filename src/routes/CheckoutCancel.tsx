  ...
  return (
    <div className="mx-auto flex min-h-[60vh] w-full max-w-3xl flex-col items-center justify-center gap-6 px-4 py-16 text-center">
      <div className="space-y-4">
        <p className="text-xs font-semibold uppercase tracking-[0.42em] text-brand">Checkout canceled</p>
        ...
        <p className="text-sm leading-relaxed text-[var(--fg-muted)]">
          The payment was not completed. You can retry the checkout or explore other courses in our directory.
        </p>
      </div>
      ...
      <p className="text-xs leading-relaxed text-[var(--fg-muted)]">
        Need help finishing your purchase? Email us at <a className="font-semibold text-brand" href="mailto:support@bitcoin-square.com">support@bitcoin-square.com</a>.
      </p>
    </div>
  );
}
